...
<section className='grid grid-cols-5 gap-10 justify-between p-24 gdg'>
   <div>
          <ul>
              <li className='font-semibold miles pb-2'>About</li>
              <li>Rent on Rk</li>
              <li>Policies</li>
              <li>Help</li>
          </ul>
    ...
    <div>
        <ul>
            <li className='font-semibold miles pb-2'>Socail</li>
            <li>Facebook</li>
            <li>Twitter</li>
            <li>Instagram</li>
        </ul>
    ...
    <div>
          <ul>
                <li className='font-semibold miles pb-2'>More</li>
                <li>Sitemap</li>
                <li>Blog</li>
                <li>Blog</li>
                <li>Blog</li>
    ...
    <div>
            <ul>
                  <li className='font-semibold miles pb-2'>Contact</li>
